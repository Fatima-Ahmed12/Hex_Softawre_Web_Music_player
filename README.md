...
<li>To apply colors and style using CSs to enhance the beauty and design of the website. </li>
<li>To use Vanilla javascript to make website interactive and dynamic.</li>
</ul>
<h2> Features</h2>
<ul type=disc>
